	...
	<div class="container">
		<a class="navbar-brand" href="<?php echo $base_url; ?>">
			<?php if($website_logo == ""){
				...
				echo "<img src='admin/upload/$website_logo' height='40px'>";
			} ?>	
		</a>
			...
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu">
						...
						?>
							<a class="dropdown-item" href="category.php?category_url=<?php echo $navbar_category_url; ?>"><?php echo $navbar_category_name; ?></a>
						<?php } ?>
					</div>
				</li>
				<?php
				...
				?>
					<li class="nav-item">
						<a class="nav-link" href="<?php echo $base_url; ?>/page.php?page_url=<?php echo $header_page_url; ?>"><?php echo $header_page_title; ?></a>
					</li>
				<?php } ?>
				<!--<li class="nav-item">
