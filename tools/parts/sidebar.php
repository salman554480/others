<div class="col-md-3">
	<?php if ($ad_code_two == "") { ?>
		<img class="w-100 mb-3" src="https://dummyimage.com/400x400/caccd1/ffffff&text=Ads+Place+2" alt="">
	<?php } else {
		echo $ad_code_one;
	}
	?>
	<div class="bg-white p-3 custom-shadow">
		...
		?>
			...
			<div class="list-group sidebar-list  mb-5">
				...
				?>
					<a href="tool_details.php?tool_url=<?php echo $tool_url; ?>" class="list-group-item list-group-item-action"><?php echo $tool_name; ?></a>
				<?php } ?>
			</div>
		<?php } ?>
