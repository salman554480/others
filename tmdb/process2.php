...
<body>
    ...
    <div class="container pt-5">
        <div class="row">
            ...
            <div class="col-md-9">
                 <h1 class="mt-2 name"><?php echo $showName; ?></h1>
                 <h2 class=""><strong>Language:</strong> <?= ucfirst($original_language); ?> | <strong>Total Seasons:</strong> <?= count($seasons) ?></h3>
                 <h2><strong>Overview:</strong> <?= $overview; ?></h4>
            </div>
        </div>
