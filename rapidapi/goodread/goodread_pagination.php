...
// SQL query to get the total number of records in the 'goodread' table
$sql_total = "SELECT COUNT(*) as total_records FROM goodread";
...
$sql = "SELECT * FROM goodread LIMIT $offset, $records_per_page";
