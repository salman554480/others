...
// SQL query to get the total number of records in the 'quote' table
$sql_total = "SELECT COUNT(*) as total_records FROM quote";
...
$sql = "SELECT * FROM quote LIMIT $offset, $records_per_page";
