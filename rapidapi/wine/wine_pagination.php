...
// SQL query to get the total number of records in the 'wine' table
$sql_total = "SELECT COUNT(*) as total_records FROM wine";
...
$sql = "SELECT * FROM wine LIMIT $offset, $records_per_page";
