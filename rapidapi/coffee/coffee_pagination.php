...
// SQL query to get the total number of records in the 'coffee' table
$sql_total = "SELECT COUNT(*) as total_records FROM coffee";
...
$sql = "SELECT * FROM coffee LIMIT $offset, $records_per_page";
