...
(4, '0CFCFBF1', '', '', '513', '487'),
(5, 'AEB32872', '', '', '408', '252'),
(6, '39710840', '', '', '4672', '7008'),
(7, '9EF71F31', '', '', '500', '750'),
(8, '68E5DE56', '', '', '4817', '3303'),
(9, '1381DD9E', '', '', '640', '439');
...
(1, 'Webster title', 'http://localhost/extras/others/textbehindimage', 'foldious-high-resolution-logo-white-transparent.png', 'Calculator-icon.png', '', '', '', '', 'About Section Data', 'aboutwebster', 'aboutwebster', 'aboutwebster', 'aboutwebster');
...
--
ALTER TABLE `font`
  MODIFY `font_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
