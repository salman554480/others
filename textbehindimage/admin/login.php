...
<body style="background-image:url('assets/img/back.jpg');background-size:cover; background-position:center;">
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        if (mysqli_num_rows($run) > 0) {
                                            ...
                                            if ($email ==   $user_email && $password ==  $user_password) {
                                                ...
                                                echo "<div class='bg-danger p-1 text-light my-2'>Invalid Login</div>";
                                            }
                                        } else {
                                            echo "<div class='bg-danger p-1 text-light my-2'>No Email Found</div>";
                                        }
                                    }
